...
public class Shop : MonoBehaviour
{
    ...
    [SerializeField]
    private Image[] tabButtons = new Image[2];
    [SerializeField]
    private AudioSource purchaseSound;
    [SerializeField]
    private GameObject acceptPanel;
    [SerializeField]
    private Animator canvasHandler, skinViewAnimator, buyButtonAnimator;
    [SerializeField]
    private TextMeshProUGUI skinName, buttonLabel, moneyView, secondMoneyView;
    [SerializeField]
    ...
    private void SetListener(Skin skin)
    {
        ...
        if (!skin.isPurchased)
        {
            ...
            buttonLabel.text = LocalizeManager.GetLocalizedString(LocalizeManager.BuyFor, false) + price.ToString() + "$";
