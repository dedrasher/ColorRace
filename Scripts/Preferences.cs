...
public static class Preferences
{
    ...
    private const string TutorialCompletedKey = "TUTORIAL_COMPLETED_KEY";
    ...
    public static bool TutorialCompleted
    {
        get
        {
            return Convert.ToBoolean(PlayerPrefs.GetInt(TutorialCompletedKey));
        }
        set
        {
            PlayerPrefs.SetInt(TutorialCompletedKey, Convert.ToInt32(value));
            PlayerPrefs.Save();
        }
    }
